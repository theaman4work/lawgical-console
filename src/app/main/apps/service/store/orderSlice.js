...
export const getOrder = createAsyncThunk('servicesApp/order/getOrder', async params => {
...
export const saveOrder = createAsyncThunk('servicesApp/order/saveOrder', async order => {
