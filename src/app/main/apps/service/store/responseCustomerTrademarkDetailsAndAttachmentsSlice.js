...
export const getResponseCustomerTrademarkDetailsAndAttachments = createAsyncThunk(
...
const responseCustomerTrademarkDetailsAndAttachmentsSlice = createSlice({
...
export default responseCustomerTrademarkDetailsAndAttachmentsSlice.reducer;
